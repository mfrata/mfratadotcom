...
the night[^5].  If I start to work early like 7 am or 8 am, I take another
break around 10 am!  Likewise, scheduling buffer and commuting time is crucial.
We forget that between two events or tasks there will be transitions, either
physical or mental. So, between two meetings remember to set a 15 minute time
window. When you have to go somewhere include the commute time on the task
block!
